...
if (progressValue == 30 ) {   //put here percentage
...
<meter value="${obj.correctAnswer}" min="0" max="${obj.totalAnswer}" optimum="${passedScore}" low="${obj.totalAnswer/2}"></meter> <br><br>
<h4>Wrong ${falseAnswer}/${obj.totalAnswer}</h4>
<meter value="${falseAnswer}" min="0" max="${obj.totalAnswer}" optimum="${passedScore}" low="${obj.totalAnswer/2}"></meter> <br><br>
`
